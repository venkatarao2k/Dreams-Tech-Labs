  ...
  return (
    <section id="contact" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass rounded-2xl p-5 border border-indigo-500/20 text-center mb-8">
          <p className="text-slate-300 text-sm">
            🌐 We support &nbsp;
            <span className="text-white font-semibold">తెలుగు (Telugu)</span> &nbsp;·&nbsp;
            <span className="text-white font-semibold">English</span> &nbsp;·&nbsp;
            <span className="text-white font-semibold">தமிழ் (Tamil)</span> &nbsp;·&nbsp;
            <span className="text-white font-semibold">हिंदी (Hindi)</span>
